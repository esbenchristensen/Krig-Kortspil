...
class Game {
    ...
    compareWarCards() {
        let player1rank = newGame.player1CardsInPlay[0].rank + newGame.player1CardsInPlay[1].rank + newGame.player1CardsInPlay[2].rank;
        let player2rank = newGame.player2CardsInPlay[0].rank + newGame.player2CardsInPlay[1].rank + newGame.player2CardsInPlay[2].rank;
        if (player1rank > player2rank) {
            ...
            document.querySelector("#playerOneCardImage").className = "";
            document.querySelector("#playerTwoCardImage").className = "";
            document.querySelector("#playerOneCardRank").innerHTML = player1rank;
            document.querySelector("#playerTwoCardRank").innerHTML = player2rank;
            document.querySelector("#winningPlayer").innerHTML = "Draw";
            newGame.warBool = true;
            alert("Draw in war");
        }
    }
    compareCards() {
...
console.log(newPlayer1.cards.length);
console.log(newPlayer2.cards.length);
console.log(newGame.deck.length);
